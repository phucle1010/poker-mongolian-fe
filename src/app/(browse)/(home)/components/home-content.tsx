              ...
              <div className="text_box mt-16" ref={textWrapperRef}>
                <div className="text_wrapper">
                  <div className="letters">
                    Жижиг гэлтгүй аливаа алхам урагшилдаг. Энэ нь маш амархан.
                    бидний мөрөөдөл. Үүнээс хойш байнгын, шийдэмгий шийдвэрүүд
                    гарна. Үргэлжлүүлээрэй. Хамгийн жижиг асуудал бол илүү том
                    асуудал болно. Энэ нь хүрэх замд ялах тухай юм.
                  </div>
                </div>
              </div>
            ...
            <div className="banner_play ">
              ...
              <div className="area">
                <div className="context">
                  <p>
                    <span className="animate-aitf">Хүн бүр Hold'em </span>
                  </p>
                  ...
                  <div className="flex flex-center mt-24">
                    ...
                    >
                      ...
                      <span className="color-white">тоглоом тоглох</span>
                    </Link>
                  </div>
                </div>
          ...
          <div className="col-12 col-md-6 col-lg-4">
            <a className="imgDrop block_points h-full" href="#">
              ...
              <div className="box__link button-animation text-center">
                Үзэхийн тулд товшино уу<span></span>
                <span></span>
                <span></span>
                <span></span>
              </div>
          ...
          <div className="row gapy-24 ">
            <div className="col-12 col-md-6 col-lg-4">
              <div className="ttl_sub">
                {' '}
                <span>Тоглоомын дүрмийн нэр томъёо</span>
              </div>
              <ul className="list_btn mt-20">
                <li>
                  <a href="#">
                    {' '}
                    <span className="text">Нөхцөл ба нөхцөл</span>
                ...
                <li>
                  <a href="#">
                    {' '}
                    <span className="text">покерын дүрэм</span>
                    <span className="arrow"></span>
                  </a>
                </li>
              </ul>
            ...
            <div className="col-12 col-md-6 col-lg-4">
              <div className="ttl_sub">
                {' '}
                <span>Купон оноо солилцох</span>
              </div>
              <a className="bnr_link bnr_points mt-20" href="#">
                <b>Цэг дээр дарна уу</b>
              </a>
            </div>
            <div className="col-12 col-md-6 col-lg-4">
              <div className="ttl_sub">
